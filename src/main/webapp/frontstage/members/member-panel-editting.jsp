...
<html lang="zxx">
  ...
  <body>
        ...
        <div class="row ding-panel">
          ...
          <div class="col-9 p-2 bg-light border">
            ...
            <div class="row">
              <div class="col-9">
                <!-- -----------會員資料表單(編輯模式)開始----------->
                <form class="pl-5" METHOD="post" ACTION="<%=request.getContextPath()%>/MembersServlet" name="form1" enctype="multipart/form-data">
                  <div class="form-group form-row">
                    <label for="memberstatus" class="col-sm-2 col-form-label ding-data-short">狀態：</label>
                    <div class="col-sm-10">
                      <input type="text" readonly   class="form-control" id="memberStatus" name="member_status" value="<%=memVO.getMemberStatus()%>" />
                    </div>
                  </div>
                  <div class="form-group form-row">
                    <label for="account" class="col-sm-2 col-form-label ding-data-short">帳號：</label>
                    <div class="col-sm-10">
                      <input type="text" readonly   class="form-control-plaintext" name="member_account" id="account" value="<%=memVO.getMemberAccount()%>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group form-row">
                    ...
                    <div class="col-sm-10">
                      <div class="custom-control custom-radio custom-control-inline mt-2">
                        <input type="radio" id="male" name="member_gender" class="custom-control-input" value="0"/>
                        <label class="custom-control-label" for="male">男</label>
                      </div>
                      <div class="custom-control custom-radio custom-control-inline mt-2">
                        <input type="radio" id="female" name="member_gender" class="custom-control-input" value="1"/>
                  ...
                  <div class="form-group form-row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="nickname" name="member_nickname" value="<%=memVO.getMemberNickname()%>" />
                    </div>
                  </div>
                  <div class="form-group form-row">
                    <label for="birthdate" class="col-sm-2 col-form-label ding-data-short">生日：</label>
                    <div class="col-sm-10">
                      <input type="date" class="border" id="birthdate" name="member_date" name="member_date" value="<%=memVO.getMemberDate()%>"/>
                    </div>
                  </div>
                  <div class="form-group form-row">
                    <label for="address" class="col-sm-2 col-form-label ding-data-short">地址：</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="address" name="member_address" value="<%=memVO.getMemberAddress()%>" />
                    </div>
                  </div>
                  <div class="form-group form-row">
                    <label for="location" class="col-sm-3 col-form-label ding-data-long">國別：</label>
                    <div class="col-sm-9">
                      <input type="text" readonly class="form-control" id="location" name="member_country" value="<%=memVO.getMemberCountry()%>" />
                    </div>
                  </div>
                  <div class="form-group form-row">
                    <label for="phonenumber" class="col-sm-3 col-form-label ding-data-long">聯絡電話：</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="member_cellphone" id="phonenumber" value="<%=memVO.getMemberCellphone()%>" />
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="email" class="col-sm-3 col-form-label ding-data-long">電子信箱：</label>
                    <div class="col-sm-9">
                      <input type="text" readonly  name="member_mail"  class="form-control-plaintext" id="email" value="<%=memVO.getMemberMail()%>" />
                    </div>
                  </div>
                  <div class="form-group form-row">
					  <label for="introduction" class="col-sm-3 col-form-label ding-data-long">簡介：</label>
					  <div class="col-sm-9">
					    <textarea class="form-control" name="member_introduce" id="introduction" rows="5"><%= memVO.getMemberIntroduce()%></textarea>
					  </div>
				  </div>
                  ...
                  <div class="ding-mem-btn">
                    ...
                    <button type="submit" class="btn ding-btn-outline-org">確定修改</button>
                  </div>
              ...
              <div class="col-3 ding-mem-img">
   				<img id="image-preview" src="/CookLab/MembersImgServlet?memberId=<%=memVO.getMemberId()%>" alt="會員頭像" style="display:blank; max-width: 200px; max-height: 200px;" class="rounded-circle mt-4">
                ...
                <div class="mt-2">
					...
					<button type="button" onclick="document.getElementById('image-upload').click();" class="btn ding-btn-outline-org">瀏覽圖片</button>
    ...
    <script>        
	    ...
	    var memberGenderValue = <%=memVO.getMemberGender()%>; // 你可以根据实际需要获取值
