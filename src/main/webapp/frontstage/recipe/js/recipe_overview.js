...
//放一個食譜到頁面
function addListRecipe(recipe) { //<li><i class="fa fa-comment-o"/>留言數:5</li>
	let addrecipe = `<div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <p>${recipe.introduction.length > 18 ? recipe.introduction.substring(0, 18) + "..." : recipe.introduction}</p>
                                </div>
                            </div>
                        </div>`;
...
$(function() {
	...
	if (concatenatedString.length > 18) {
		concatenatedString = concatenatedString.substring(0, 18) + "...";
	}
