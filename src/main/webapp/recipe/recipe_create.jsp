...
<!-- bootstrap-icon -->
<link rel="stylesheet"
	href="./bootstrap-icons-1.10.5/font/bootstrap-icons.css" />
<!-- 自增CSS -->
...
<body>
	...
	<section class="hero hero-normal"
		style="background-color: rgb(226, 222, 222); padding: 30px">
		<div class="row">
			...
			<div class="col-md-8 recipe-content">
				<div class="row">
					...
					<div class="col-md-6">
						<input type="text" id="recipeName"
							class="form-control recipe-name" placeholder="請輸入食譜名稱" />
					</div>
					<div class="col-md-2">
						<button type="submit" class="site-btn"
							style="background-color: #f27405">確認名稱</button>
					</div>
				</div>
				...
				<div class="text-center" style="margin: 30px">
					<div id="coverImageView">
						<span class="text">成品圖片<br />(點擊或拖曳)
						</span> <input type="file" id="coverImageInput" accept="image/*"
							style="display: none" />
					</div>
				</div>
				...
				<div>
					...
					<textarea id="introduction" class="form-control martin-textarea"
						aria-label="With textarea" placeholder="內容"></textarea>
				</div>
						...
						<div class="row align-items-center" style="margin: 5px">
							<div class="col-md-5">
								<input type="text" class="form-control ingredient"
									placeholder="請輸入食材" category="Ingredient"
							...
							<i class="bi bi-list">&emsp;</i> <i
								class="bi bi-trash3-fill delete-ingredient"></i>
						</div>
				...
				<div>
					...
					<div id="listKitchenware" class="search-init">
						<div class="row align-items-center" style="margin: 5px">
							<div class="col-md-5">
								<input type="text" class="form-control kitchenware"
									placeholder="請輸入廚具" category="Kitchenware"
									oninput="searchProduct(this)" />
								<div class="search-results"></div>
							</div>

							<i class="bi bi-list">&emsp;</i> <i
								class="bi bi-trash3-fill delete-kitchenware"></i>
						</div>
						<div class="row align-items-center" style="margin: 5px">
							<div class="col-md-5">
								<input type="text" class="form-control kitchenware"
				...
				<div>
					...
					<div id="listStep">
						<div class="row step" step="1">
							<div class="col-md-3 text-center">
								<div class="step-img-view">
									<span class="text">步驟圖片</span> <input type="file"
										class="step-img-input" accept="image/*" style="display: none" />
								</div>
							</div>
							<div class="col-md-8">
								<div class="row">
									<span class="recipe_content col-md-2">步驟1:</span> <input
										type="text" class="form-control col-md-3 step-time"
										placeholder="花費時間(分鐘)" />
								</div>
								<textarea class="form-control martin-textarea step-content"
									aria-label="With textarea" placeholder="步驟說明"></textarea>
							</div>
							<i class="bi bi-list">&emsp;</i> <i
								class="bi bi-trash3-fill delete-step"></i>
						</div>
						...
						<div class="row step" step="2">
							...
							<div class="col-md-8">
								<div class="row">
									<span class="recipe_content col-md-2">步驟2:</span> <input
										type="text" class="form-control col-md-3 step-time"
										placeholder="花費時間(分鐘)" />
								</div>
								<textarea class="form-control martin-textarea step-content"
						...
						<div class="row step" step="3">
							...
							<div class="col-md-8">
								<div class="row">
									<span class="recipe_content col-md-2">步驟3:</span> <input
										type="text" class="form-control col-md-3 step-time"
										placeholder="花費時間(分鐘)" />
								</div>
								<textarea class="form-control martin-textarea step-content"
				...
				<div>
					...
					<textarea id="additionalExplanation"
						class="form-control martin-textarea" aria-label="With textarea"
