                    ...
                    return (
                      ...
                      (d.format = function (t) {
                        ...
                        var e = t || "YYYY-MM-DDTHH:mm:ssZ",
                          ...
                          m = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a + 1, MM: g.s(a + 1, 2, "0"), MMM: c(i.monthsShort, a, h, 3), MMMM: h[a] || h(this, e), D: this.$D, DD: g.s(this.$D, 2, "0"), d: String(this.$W), dd: c(i.weekdaysMin, this.$W, u, 2), ddd: c(i.weekdaysShort, this.$W, u, 3), dddd: u[this.$W], H: String(s), HH: g.s(s, 2, "0"), h: d(1), hh: d(2), a: l(s, o, !0), A: l(s, o, !1), m: String(o), mm: g.s(o, 2, "0"), s: String(this.$s), ss: g.s(this.$s, 2, "0"), SSS: g.s(this.$ms, 3, "0"), Z: r };
      ...
      2: [
        function (require, module, exports) {
              ...
              Promise.all(c).then((i) => {
                ...
                Array.from(n).forEach((e) => {
                  const s = e.cells[t],
                    a = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                  let i;
                  (i = c ? c(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a), parseFloat(i) == i ? (r[o++] = { value: Number(i), row: e }) : (l[h++] = { value: "string" == typeof a ? a.toLowerCase() : a, row: e });
                }),
                  e || (e = d.classList.contains("asc") ? "desc" : "asc"),
                  "desc" == e ? ((p = sortItems(l, -1)), (u = sortItems(r, -1)), d.classList.remove("asc"), d.classList.add("desc")) : ((p = sortItems(r, 1)), (u = sortItems(l, 1)), d.classList.remove("desc"), d.classList.add("asc")),
          ...
          const dataToTable = function (t) {
            ...
            defaultConfig = { sortable: !0, searchable: !0, paging: !0, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: !0, firstLast: !1, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", ascText: "▴", descText: "▾", truncatePager: !0, pagerDelta: 2, scrollY: "", fixedColumns: !0, fixedHeight: !1, header: !0, footer: !1, labels: { placeholder: "搜尋", perPage: "{select}", noRows: "No entries found", info: "Showing {start} to {end} of {rows} entries" }, layout: { top: "{select}{search}", bottom: "{info}{pager}" } };
          class DataTable {
            constructor(t, e = {}) {
              if (((this.initialized = !1), (this.options = { ...defaultConfig, ...e, layout: { ...defaultConfig.layout, ...e.layout }, labels: { ...defaultConfig.labels, ...e.labels } }), "string" == typeof t && (t = document.querySelector(t)), (this.initialLayout = t.innerHTML), (this.initialSortable = this.options.sortable), this.options.header || (this.options.sortable = !1), null === t.tHead && (!this.options.data || (this.options.data && !this.options.data.headings)) && (this.options.sortable = !1), t.tBodies.length && !t.tBodies[0].rows.length && this.options.data && !this.options.data.data)) throw new Error("You seem to be using the data option, but you've not defined any rows.");
            ...
            render(t) {
              ...
              if (
                ...
                (t += e.labels.perPage), (t += "<label>每頁筆數</label></div>");
