      ...
      2: [
        function (require, module, exports) {
          ...
          const dataToTable = function (t) {
            ...
            defaultConfig = { sortable: !0, searchable: !0, paging: !0, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: !0, firstLast: !1, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", ascText: "▴", descText: "▾", truncatePager: !0, pagerDelta: 2, scrollY: "", fixedColumns: !0, fixedHeight: !1, header: !0, footer: !1, labels: { placeholder: "搜尋", perPage: "{select}", noRows: "查無資料", info: "顯示 {start} 到 {end} 其中的 {rows} 筆" }, layout: { top: "{select}{search}", bottom: "{info}{pager}" } };
          class DataTable {
            constructor(t, e = {}) {
