						...
						<div class="col-md-9 card-header"
													...
													<c:if test="${artVO.categoryStatus == 0}">
														<tr>
															<td><input class="form-check-input" type="checkbox"
																value="${artVO.articleCategoryNo}"
																name="articleCategoryNo"
																id="permission${artVO.articleCategoryNo}" /> <input
																type="hidden" name="action" value="update"></input> <label
																class="form-check-label"
																for="permission${artVO.articleCategoryNo}">
							...
							<div style="position: relative; left: 10%">
								<FORM METHOD="POST"
									...
									<input type="text" id="newruletitle" style="position: relative"
										name="articleCategory" placeholder="輸入分類"
										value="${(artVO2 == null) ? '' : artVO2.getArticleCategory()}">
