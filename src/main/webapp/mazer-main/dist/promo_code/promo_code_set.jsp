                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="./promo_code_allview.jsp">優惠券總覽</a></li>
                    ...
                    <div class="col-lg-12">
                        <section id="basic-horizontal-layouts">
                            <div class="row match-height" style=" position: relative;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" class="GCpromo_info"
                                                                    id="promo_id" name="promo_info" value="000001"
                                                                    disabled >
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼名稱</label>
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" id="promo_name"
                                                                    class="GCpromo_info" name="promo_info"
                                                                    value="滿兩千免運費" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼序號</label>
                                                            </div>
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" id="promo_serial_number"
                                                                    class="GCpromo_info" name="promo_info"
                                                                    value="ZXC1234" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼開始</label>
                                                            </div>
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" class="GCpromo_info"
                                                                    name="promo_info" id="promo_start_time"
                                                                    value="2023/01/01" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼結束</label>
                                                            </div>
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" class="GCpromo_info"
                                                                    name="promo_info" id="promo_offsale_time"
                                                                    value="2023/12/30" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼總共次數</label>
                                                            </div>
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" class="GCpromo_info"
                                                                    name="promo_info" id="promo_count"
                                                                    value="100" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>優惠碼剩餘次數</label>
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" class="GCpromo_info"
                                                                    name="promo_info" id="promo_remain_count"
                                                                    value="50" disabled>
                                                            </div>
                                ...
                                <div class="col-md-6 "> 
                                       <button class="wcc" style="border-radius: 20px" >新增優惠券</button>  
                                </div>
                                <!-- ///////////////// -->
