                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12" style="margin-top: 20px;">
                                                        <div class="form-group">
                                                            <label for="productname-vertical">商品名稱</label>
                                                            <input type="text" id="productname-vertical"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="productprice-vertical">商品售價</label>
                                                            <input type="number" id="productprice-vertical"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="uptime-vertical">上架時間</label>
                                                            <input type="datetime-local" step="1" id="uptime-vertical"
                                                                class="form-control" name="uptime">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="downtime-vertical">下架時間</label>
                                                            <input type="datetime-local" step="1" id="downtime-vertical"
                                                                class="form-control" name="downtime">
                                                        </div>
                                                    </div>
                                                    <div class="row">
