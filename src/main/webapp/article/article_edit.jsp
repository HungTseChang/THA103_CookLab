		...
		<div class="container" id="another">
			<div class="row">
				...
				<FORM METHOD="post" ACTION="<%= request.getContextPath() %>/ArticleServlet" name="form1">
						...
						<input type="hidden" name="articleStatus"placeholder="輸入文章狀態(數字)" value="0" size="45" /> 
						<input type="hidden" name="articleCount" placeholder="輸入回文數量"  value="0" size="45"/>
						<input type="hidden" name="viewCount"  placeholder="輸入次數" value="0" size="45"/>
						...
						<input type="text" id="edit_title" name="articleTitle"
							placeholder="輸入標題"
							value="<%=(artVO2 == null) ? "" : artVO2.getArticleTitle()%>">

						<div style="width: auto; height: 500px;">
							<div id="editor" contenteditable="true"><!-- 使用 contenteditable 屬性使 <div> 可編輯 -->							
							</div>
