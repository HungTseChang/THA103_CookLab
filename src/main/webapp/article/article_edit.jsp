        ...
        <div class="container" id="another">
            <div class="row">
                <div class="col-md-2" id="left_img" ;
                    ...
                    <button type="button" class="btn ding-btn-org" style="margin-top: 50px;">引用食譜</button>
                ...
                <form method="post" action="/com.tha103.cooklab/ArticleServlet" name="form1">
                    ...
                    <select name="articleCategory">
                        <option value="1">綜合分類</option>
                        <option value="2">食譜討論</option>
                        <option value="3">食材討論</option>F
                        <option value="4">活動資訊</option>
                    ...
                    <input type="text" id="edit_title" value="請輸入標題">

                    <div style="width: auto; height: 500px;">
                        <div  id="editor">
                            <h2 class="firstview">快來寫下你的文章</h2>
                        </div>
                        <textarea name="quillContent"></textarea> <!-- 這是要接收Quill編輯器內容的textarea -->
                        <p style="margin-top: 5px;">驗證碼顯示位置: <input type="text" value="請輸入驗證碼">
                            <button class="btn ding-btn-org" id="btn_confirm">確定</button>
                            <button class="btn ding-btn-org" id ="btn_drawft">儲存草稿</button>
