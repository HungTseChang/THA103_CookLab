...
<table>
	...
	<tr>
		<td>文章狀態:</td>
		<td><input type="TEXT" name="articleStatus" placeholder="輸入文章狀態(數字)" value="<%= (artVO==null)? "" : artVO.getArticleStatus()%>" size="45"/></td>		
	</tr>
	<tr>
		<td>文章內容:</td>
		<td><input type="TEXT" name="articleContent"  placeholder="輸入文章內容" value="<%= (artVO==null)? "" : artVO.getArticleContent()%>" size="45"/></td>		
